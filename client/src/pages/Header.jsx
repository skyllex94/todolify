...
function Header() {
  ...
  return (
    <div>
      <header>
        <nav
          className="absolute z-20 w-full h-20 bg-white/90 dark:bg-gray-900/80 backdrop-blur  
        shadow-2xl shadow-gray-600/5 border-b border-gray-100 dark:border-gray-800 
        peer-checked:navbar-active dark:shadow-snone"
        >
          <div className="xl:container md:container m-auto px-6 md:px-12 lg:px-6">
            <div className="flex flex-wrap items-center justify-between gap-6 md:gap-0 md:py-5">
              ...
              {toggleNav ? (
                <div
                  className="w-full flex-wrap mb-16 justify-end items-center space-y-8 p-6 border border-gray-100 
                ...
                <div className="navmenu flex items-center"></div>
              )}
            </div>
          </div>
        </nav>
